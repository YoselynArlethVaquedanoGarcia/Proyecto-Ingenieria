                    ...
                    <ul id="sidebarnav" class="pt-4">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level">
                                <li class="sidebar-item"><a href="../html/ltr/usuario.php" class="sidebar-link"><i
    ...
    <div class="col-12 d-flex no-block align-items-center">
      ...
      <div class="col-md-9 order-2">
            ...
            <div class="row">
              ...
              <h1 class="font-weight-light text-center text-lg-left mt-4 mb-0" style="color:black">Control de Servicios</h1>
              <hr class="mt-2 mb-5">
    ...
    <?php
                   ...
                   <p class="text-primary font-weight-bold">Fecha de Publicación <?php echo $resultado["Fecha_Registro"]; ?></p>
                      <?php $fecha_publicacion = new DateTime($resultado["Fecha_Registro"]);
                            ...
                            //var_dump($mes);
                            if ( $mes>=$dato){
                                echo "<h4 style='background-color:red; color:white'>Servicio Caducado</h4>
                                    <a href='../config/eliminarServicios.php?idProducto=".$resultado['idProducto']."''>
                                    <button type='button' class='btn btn-danger'>Eliminar</button></a>";
                            }
                            else{
                                echo "<h4 style='background-color:green; color:white'>Servicio Vigente</h4>";
                            }
                      ?>
