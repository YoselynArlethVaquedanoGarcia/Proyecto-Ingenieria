                                    ...
                                    <table class="table table-striped table-advance table-hover">
                                        <tbody>
                                          <tr>
                                            ...
                                            <th><i class="icon_calendar"></i> Género</th>
                                          ...
                                          <?php 
                                            ...
                                            $resultadoCon=mysqli_query($conexion,$consultaCon);
                                              ...
                                              while ($resultado = mysqli_fetch_array($resultadoCon)) {
                                          ...
                                          <tr>
                                            ...
                                            <td>
                                              <div class="btn-group">
                                                <a class="btn btn-danger" href="../../config/eliminarUsuario.php?idUsuario=<?php echo $resultado["idUsuario"]; ?>"><i class="icon_close_alt2"></i></a>
                                              </div>
                                            </td>
                                          </tr>
                                          <?php } ?>
